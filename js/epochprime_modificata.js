...
function EpochPrime(targetelement,xmlconfig) {
	...
	function calConfig() {
		...
		self.minDate = new Date(2015,0,1); //the earliest date the user can choose
		self.maxDate = new Date(); //the latest data the user can choose
		self.startDay = 1; //the day the week will 'start' on: 0(Sunday) to 6(Saturday)
